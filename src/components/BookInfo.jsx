...
import {GetABook, CreateABook} from "../api/book"
...
function BookInfo({ book }) {
    ...
    return (
        <form className="my-10 bg-white p-5 rounded-lg border border-sky-600">                    
            <div
                className="flex"
            >
                <img
                    src={image}
                    alt=""
                    className="object-contain h-40 mx-auto my-auto"
                />
